...
labels = {"run_1":r'$\epsilon = 0.01$'+"-greedy" , "run_2": r'$\epsilon = Max(0.01, e^{-t/1000}$)', "run_3": "1-greedy", "run_4":"UCB", "run_5": "exp-"+r'$\epsilon$' + " + TS", "run_6": "exp-gre + 0.1-TS", "run_7": "TS", "run_8": "0.1(TS+TS)", "run_9": "ucb + ucb (banditalg)", "run_10": "ucb+ucb (anormal)", "run_11": "ucb + TS", "run_12": "exp-"+r'$\epsilon$' + " +ucb", "run_55": "0.3-greedy", "run_56": r'$\epsilon = Max(0.27, e^{-t/5000})$'}

labels = { 'run_1' : '1-greedy',  'run_2' : 'exp-greedy',  'run_3' : '0.3-greedy',  'run_4' : 'ucb-ucb',  'run_5' : 'exp-greedy + TS',  'run_6' : 'TS',  'run_7' : '0.1-TS',  'run_8' : 'ucb (banditalg)',  'run_9' : 'ucb (anormal)' }


runnings = {}
# runnings["ql"] = ["run_2","run_3", "run_55", "run_56"] #Q-learning plot
runnings["ql"] = ["run_2","run_3", "run_1"] #Q-learning plot
runnings["enhql"] = ["run_2","run_4", "run_5" ,"run_6"] #Enhanced q-learning plot

# runnings["comp_ep"] = ["run_2", "run_55", "run_56"]
# runnings["ucbs_methods"] = ["run_4", "run_10", "run_9"] #comparing ucb methods plot
# runnings["exp_enh_only_guess"] = ["run_2", "run_5", "run_12", "run_6"] #enhaced exp-epsilon greedy with the guess only (ucb or TS)
# runnings["ts"] = ["run_7", "run_8"]
...
for ress in [0.1]:
    ...
    for keys in ["enhql"]:
        ...
        for runs in rruns:
            ...
            ax2.plot(np.log10(re.results[0]), np.log10(re.results[3]), '-', linewidth=5,alpha=.7, color=colors[str(jj)], label=str(method))
        ...
        plt.savefig("plots/enh_final_paper_xticks.pdf")
        # plt.show()
