...
for ep in [0.01,1,0.3]:

    exper = training.Experiment(searching_method = method, layers=2, ep=ep,resolution=0.1, bound_displacements=1, states_wasted=10**3, guessing_rule="None")
    exper.train(4)
