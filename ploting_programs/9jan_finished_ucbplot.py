...
def ploting(dict, mode="minimax", mode_log="on", save=True, show=False, particular_name="std", logyaxis=False):
    ...
    for run in dict.keys():
        ...
        if once==True:
            ...
            axins = zoomed_inset_axes(ax2, zoom=4,loc="lower right")
...
colors = {"run_1": color1, "run_2": color2, "run_3":color3, "run_6":"purple", "run_8":"orange", "run_12":colorucb1, "run_13": colorucb2, "run_14":colorucb3}
...
labels = {"run_1":r'$\epsilon = 0.01$'+"-greedy" , "run_2": r'$\epsilon = 0.3$'+"-greedy", "run_3": r'$\epsilon = 1$'+"-greedy", "run_8":"Max(0.01, "+r'$e^{-t/\tau}$'+")-greedy", "run_12":"UCB-1", "run_13":"UCB-2", "run_14":"UCB-3"} #r'$\epsilon = Max(0.01, e^{-t/\tau}$)', "run_3": "1-greedy"}
...
# ,
interesting = ["run_12", "run_13","run_14"]
