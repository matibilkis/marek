...
def ploting(dict, mode="minimax", mode_log="on", save=True, show=False, particular_name="std", logyaxis=False):
    ...
    for run in dict.keys():
        ...
        if once==True:
            ...
            axins = zoomed_inset_axes(ax2, zoom=2,loc="lower right")
...
colors = {"run_1": color1, "run_2": color2, "run_3":color3, "run_6":"purple", "run_8":"orange", "run_12":colorucb1, "run_13": colorucb2, "run_14":colorucb3, "run_15":"green", "run_16":"yellow", "run_17":"brown"}
...
labels = {"run_1":r'$\epsilon = 0.01$'+"-greedy" , "run_2": r'$\epsilon = 0.3$'+"-greedy", "run_3": r'$\epsilon = 1$'+"-greedy", "run_8":"Max(0.01, "+r'$e^{-t/\tau}$'+")-greedy", "run_12":"UCB-1", "run_13":"UCB-2", "run_14":"UCB-3", "run_15":"0.01-TS", "run_16": "0.1-TS", "run_17":"1-TS"} #r'$\epsilon = Max(0.01, e^{-t/\tau}$)', "run_3": "1-greedy"}
...
# ,
interesting = ["run_15","run_16","run_17"]
...
ploting(dict_plot,mode_log="on",save=False,logyaxis=False,show=True, particular_name="ts-QL",mode="stds")
